...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and jinja2-inflection through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through jinja2-inflection
  - The ultimate goal is to run `python -m jinja2-inflection -x -t` without any errors
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_jinja2-inflection`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m jinja2-inflection --comprehensive`
